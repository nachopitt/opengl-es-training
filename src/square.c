...
int main(int argc, char* argv[]) {
    ...
    if (Init(&esContext, &userData, "Hello Square", width, height, device, ES_WINDOW_RGB, DrawSquare, NULL, NULL, NULL, "shaders/basic-color.vs", "shaders/basic.fs")) {
